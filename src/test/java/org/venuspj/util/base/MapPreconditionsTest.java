...
public class MapPreconditionsTest {
    ...
    public void testCheckSizeWithNegativeSize() {
        ...
        assertThrows(IllegalArgumentException.class, () -> MapPreconditions.checkSize(map, -1, RuntimeException::new));
    }
    ...
    public void testCheckSizeWithSizeGreaterThanMapSize() {
        Map<String, String> map = new HashMap<>();
        map.put("test", "value");
        assertThrows(RuntimeException.class, () -> MapPreconditions.checkSize(map, 2, RuntimeException::new));
    }

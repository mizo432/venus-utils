...
public final class Stats implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects2.hash(count, mean, sumOfSquaresOfDeltas, min, max);
  }
  ...
  public String toString() {
    if (count() > 0) {
      ...
      return Objects2.toStringHelper(this).add("count", count).toString();
    }
  }
   ...
   * {@link ByteOrder#LITTLE_ENDIAN}, to which a BYTES-long byte representation of this instance is
   * written. In the process increases the position of {@link ByteBuffer} by BYTES.
   */
   ...
   *
   * @param buffer A {@link ByteBuffer} with at least BYTES {@link ByteBuffer#remaining}, ordered as
   * {@link ByteOrder#LITTLE_ENDIAN}, from which a BYTES-long byte representation of this instance
   * is read. In the process increases the position of {@link ByteBuffer} by BYTES.
   */

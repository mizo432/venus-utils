 ...
 * two separate characters. {@link #countIn} counts each supplementary character as 2
 * {@code char}s.
 *
...
public abstract class CharMatcher implements Predicate<Character> {
   ...
   * {@linkplain Character#isDigit(char) Java's definition}. If you only care to match ASCII digits,
   * you can use {@code inRange('0', '9')}.
   *
   ...
   * {@linkplain Character#isLetter(char) Java's definition}. If you only care to match letters of
   * the Latin alphabet, you can use {@code inRange('a', 'z').or(inRange('A', 'Z'))}.
   *

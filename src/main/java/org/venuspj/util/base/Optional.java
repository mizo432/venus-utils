 ...
 * {@code T} reference. It allows you to represent "a {@code T} that must be present" and a "a
 * {@code T} that might be absent" as two distinct types in your program, which can aid clarity.
 *
 ...
 * this type, so it is safe to cast an {@code Optional<T>} to {@code Optional<S>} for any supertype
 * {@code S} of {@code T}.
 */
public abstract class Optional<T> implements Serializable {
  ...
  /**
   * Returns an {@code Optional} instance containing the given non-null reference. To have
   * {@code null} treated as {@link #absent}, use {@link #fromNullable} instead.
   *
  ...
  /**
   * Returns the equivalent {@code java.util.Optional} value to the given
   * {@code com.google.common.base.Optional}, or {@code null} if the argument is null.
   *
   ...
   * {@code Optional<Number>} (where {@code Number} is the desired output type) solves the problem:
   *
   * <pre>{@code

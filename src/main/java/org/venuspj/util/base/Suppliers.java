...
public final class Suppliers {
  ...
  private static class SupplierComposition<F, T> implements Supplier<T>, Serializable {
    ...
    @Override
    public int hashCode() {
      return Objects2.hash(function, supplier);
    }
   ...
   *
   * <p>The returned supplier is thread-safe. The delegate's {@code get()} method will be invoked
   * at most once unless the underlying {@code get()} throws an exception. The supplier's serialized

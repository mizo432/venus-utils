...
public abstract class Converter<A, B> implements Function<A, B> {
   ...
   * then this is not logically a {@code Converter} at all, and should just implement
   * {@link Function}.
   */
   ...
   *
   * <p>The returned iterable's iterator supports {@code remove()} if the input iterator does.
   ...
   *
   * <p>The returned converter is serializable if {@code this} converter and

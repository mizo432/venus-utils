...
public final class Strings {
   ...
   * {@code String.format} is not available. As an example, method implementations of the
   * {@link Preconditions} class use this formatter, for both of the reasons just discussed.
   *
   * <p><b>Warning:</b> Only the exact two-character placeholder sequence {@code "%s"} is
   * recognized.
   *
   * @param template a string containing zero or more {@code "%s"} placeholder sequences.
   * {@code null} is treated as the four-character string {@code "null"}.

...
class ImmutableMapEntry<K extends Serializable, V extends Serializable> extends
    ImmutableEntry<K, V> {

  @SuppressWarnings("unchecked")
  static <K extends Serializable, V extends Serializable> ImmutableMapEntry<K, V>[] createEntryArray(
      int size) {
  ...
  static class NonTerminalImmutableMapEntry<K extends Serializable, V extends Serializable> extends

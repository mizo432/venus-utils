...
public final class ImmutableIntArray implements Serializable {
   ...
   * {@link Builder#addAll(Iterable)}, with all the performance implications associated with that.
   */
   ...
   * {@link ImmutableIntArray} that is built will very likely occupy more memory than strictly
  ...
  public static final class Builder {
    ...
    /**
     * Appends all values from {@code stream}, in order, to the end of the values the built
     * {@link ImmutableIntArray} will contain.
     */
   ...
   * {@code subArray(start, end).trimmed()}.
   */
  ...
  /**
   * Returns an immutable <i>view</i> of this array's values as a {@code List}; note that
   * {@code int} values are boxed into {@link Integer} instances on demand, which can be very
   * expensive. The returned list should be used once and discarded. For any usages beyond that,
   * pass the returned list to {@link (Collection) ImmutableList.copyOf} and use that list instead.
   */

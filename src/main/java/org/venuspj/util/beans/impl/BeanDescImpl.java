...
import org.venuspj.util.convert.ByteConversions;
import org.venuspj.util.convert.DoubleConversions;
import org.venuspj.util.convert.FloatConversions;
import org.venuspj.util.convert.IntegerConversions;
import org.venuspj.util.convert.LongConversions;
import org.venuspj.util.convert.ShortConversions;
...
public class BeanDescImpl implements BeanDesc {
  ...
  public boolean hasPropertyDesc(final String propertyName) {
    StringPreconditions.checkNotEmpty(propertyName, "propertyName");
  ...
  public boolean hasFieldDesc(final String fieldName) {
    StringPreconditions.checkNotEmpty(fieldName, () -> new EmptyArgumentException(
        "fieldName",
        "EUTL0010",
        asArray("fieldName")));
